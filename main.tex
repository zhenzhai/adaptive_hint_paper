...
\begin{center}
  ...
  \hline
   Week & Average tries of & P-Value \\
	...
	4 & 18.258 & 0.00146 \\
	5 & 42.598 & $3.087 * 10^{-15}$ \\
	6 & 24.406 & $4.324 * 10^{-8}$ \\
	7 & 59.130 & $2.731 * 10^{-11}$ \\
	8 & -38.860 & $1.022 * 10^{-26} $\\ \hline
    All Assignments & 48.199 & $6.434 * 10^{-9}$ \\ 
    \hline
  \end{tabular}
  \label{tab:no_hint}
  \end{center}
...
\begin{center}
  ...
  \hline
   Week & Average seconds of & P-Value \\
      & control minus case  & \\ \hline
	4 & 2394.366 & 0.000466 \\
	5 & 3778.289 & $1.839*10^{-17}$ \\
	6 & 3451.454 & $6.382*10^{-12} $\\
	7 & 10858.322 & $1.070*10^{-17}$ \\
	8 & -2163.428 & $5.055*10^{-10}$ \\ \hline
    All Assignments & 7456.791 & $6.966 * 10^{-16}$ \\ 
    \hline
  \end{tabular}
