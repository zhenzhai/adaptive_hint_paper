...
\begin{figure}[t!]
  \centering
   ...
   \captionof{figure}{This is a problem(problem 5) assigned to students in week 4. The problem is to find the probability of a specific hand in Texas Hold'em poker. This problem has four parts that students need to answer. The picture shows the second part of the problem.}
   \label{fig:hint_prob}


\captionof{table}{The table lists a few student attempts for part two of problem 5 in week 4 assignment. The problem is shown in Figure \ref{fig:hint_prob} along with the question and the solution of part 2.}
\begin{center}
...
\centering
\includegraphics[width=0.75\textwidth]{image/assignment_tries_downstream.png}
\captionof{figure}{The distribution of the attempt differences between case student and the control students. Each subplot corresponds to the distribution of an assignment. All four graphs have distribution with negative means, which means that the control students spent more attempts compared to the case students.}
    \label{fig:downstream_tries_analysis}


\centering
\includegraphics[width=0.75\textwidth]{image/assignment_time_downstream.png}
\captionof{figure}{The distribution of time (in seconds) differences between case students and control students. All distribution have negative means, showing that control students spend more time on each assignment than the case students. The results are consistent with Figure \ref{fig:downstream_tries_analysis}}
