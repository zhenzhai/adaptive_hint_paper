...
of {\bf XXX} hints by the course instructors based on logs from a previous
...
Our adaptive hint system is based on a database of hints that were beforehand based
on historical data. After we release the homework, the hint system
starts to parse student attempts to figure out students'
confusion. Then it looks for the appropriate hint in the hint database
and sends to students.
